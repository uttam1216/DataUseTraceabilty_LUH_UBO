...
class Watermarking_Correlation:
    ...
    def get_watermark_correlation(self, trips_data_dict, x1_full, watermark):
        ...
        try:
            ...
            corr_watermark_last = 0
            # print('Input watermarked traj. length does not match with current watermark file length, so exception- ')
            # print(ex)
            pass
